...
class paymentoptionModel {
  ...
  @override
  String toString() {
    return 'paymentoptionModel{status: $status, message: $message, totalWallet: $totalWallet, paymentmethods: $paymentmethods}';
  }
}
class Paymentmethods {
  ...
  @override
  String toString() {
    return 'Paymentmethods{id: $id, environment: $environment, paymentName: $paymentName, currency: $currency, testPublicKey: $testPublicKey, testSecretKey: $testSecretKey, livePublicKey: $livePublicKey, liveSecretKey: $liveSecretKey, encryptionKey: $encryptionKey, image: $image}';
  }
}