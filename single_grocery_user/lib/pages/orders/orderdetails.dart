                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${Orderdetailsdata!.userInfo!.name}",
                                  style: TextStyle(
                                      fontFamily: 'Poppins_semiBold',
                                      fontSize: 11.sp),
                                ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${Orderdetailsdata!.userInfo!.email}",
                                  style: TextStyle(
                                      fontFamily: 'Poppins_semiBold',
                                      fontSize: 11.sp),
                                ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${Orderdetailsdata!.userInfo!.mobile}",
                                  style: TextStyle(
                                      fontFamily: 'Poppins_semiBold',
                                      fontSize: 11.sp),
                                ),
                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: 82.w,
                                    child: Text(
                                      '${Orderdetailsdata!.summery!.houseNo}, ${Orderdetailsdata!.summery!.address} ,${Orderdetailsdata!.summery!.area}',
                                      style: TextStyle(
                                          fontFamily: 'Poppins',
                                          fontSize: 10.sp),
                                    ),
